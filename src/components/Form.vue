        ...
        <div class="border-b border-gray-900/10 pb-8 pt-3 ">
          ...
          <div class="mt-5 grid grid-cols-1 gap-x-5 gap-y-3 sm:grid-cols-6">
            <div class="sm:col-span-3">
              ...
              <div class="mt-0">
                <input required pattern="\S+.*" type="text" name="first-name" id="first-name" :placeholder="$t('form.firstNameLabel')" v-model="info.firstName" autocomplete="given-name" 
                  class="block w-[99%] rounded-md border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer" 
                  :class="{ 'invalid:[&:not(:focus):invalid]:border-red-500': failedSubmit }"  />
            ...
            <div class="sm:col-span-3">
              ...
              <div class="mt-0">
                <input required pattern="\S+.*" type="text" name="last-name" v-model="info.lastName" id="last-name" :placeholder="$t('form.lastNameLabel')" autocomplete="family-name" 
                  class="block w-[99%] rounded-md border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer" 
                  :class="{ 'invalid:[&:not(:focus):invalid]:border-red-500': failedSubmit }" />
                <span class="mt-2 hidden text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block" :class="{ 'peer-[&:not(:focus):invalid]:block': failedSubmit }"  >
                  Enter a valid value!
            ...
            <div class="sm:col-span-4">
              ...
              <div class="mt-0">
                <input required pattern="\S+.*" type="text" name="street-address" v-model="info.adress" id="street-address" :placeholder="$t('form.addressLabel')" autocomplete="street-address" 
                  class="block w-[99%] rounded-md border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer" 
                  :class="{ 'invalid:[&:not(:focus):invalid]:border-red-500': failedSubmit }"/>
                <span class="mt-2 hidden text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block" :class="{ 'peer-[&:not(:focus):invalid]:block': failedSubmit }"  >
                  Enter a valid value!
            ...
            <div class="sm:col-span-3">
              ...
              <div class="mt-0">
                <input required pattern="\S+.*" type="text" name="postal-code" id="postal-code" v-model="info.postalCode" :placeholder="$t('form.postalCodeLabel')" autocomplete="postal-code" 
                  class="block w-[99%] rounded-md border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer" 
                  :class="{ 'invalid:[&:not(:focus):invalid]:border-red-500': failedSubmit }"/> 
                <span class="mt-2 hidden text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block" :class="{ 'peer-[&:not(:focus):invalid]:block': failedSubmit }"  >
                  Enter a valid value!
            ...
            <div class="sm:col-span-3 sm:col-start-4">
              ...
              <div class="mt-0">
                <input required pattern="\S+.*" type="text" name="city" id="city" v-model="info.city" :placeholder="$t('form.cityLabel')" autocomplete="address-level2" 
                  class="block w-[99%] rounded-md border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer " 
                  :class="{ 'invalid:[&:not(:focus):invalid]:border-red-500': failedSubmit }"/>
                <span class="mt-2 hidden text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block" :class="{ 'peer-[&:not(:focus):invalid]:block': failedSubmit }"  >
                  Enter a valid value!
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-0">
                <country-select pattern="\S+.*" :autocomplete="true" :country="info.country" id="country" name="country" :placeholder="(fullCountry || $t('form.selectCountryLabel'))" v-model="info.countryCode" 
                  ...
                  :class="{ 'invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer': failedSubmit }"/>
                <span class="mt-2 hidden text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block" :class="{ 'peer-[&:not(:focus):invalid]:block': failedSubmit }"  >
                  Enter a valid value!
                </span>
              </div>
            ...
            <div class="sm:col-span-5">
              ...
              <div class="mt-0">
                <input id="email" required name="email" type="email" v-model="info.eMail" :placeholder="$t('form.emailLabel')" autocomplete="email" 
                  class="block w-[99%] rounded-md border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer" 
                  :class="{ 'invalid:[&:not(:focus):invalid]:border-red-500': failedSubmit }"/>
                <span class="mt-2 hidden text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block" :class="{ 'peer-[&:not(:focus):invalid]:block': failedSubmit }"  >
                  Enter a valid Email!
            ...
            <div class="sm:col-span-full">
              ...
              <div class="mt-0">
                <input  id="country" pattern="\+[0-9 ]{5,}$" required name="country" v-model="info.phoneNumber" :disabled="phoneFromQuery" autocomplete="tel" placeholder="+1 (555) 987-6543" 
                  class="block w-[99%] rounded-md border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer" 
                  :class="{ 'invalid:[&:not(:focus):invalid]:border-red-500': failedSubmit }"/>
                <span class="mt-2 hidden text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block" :class="{ 'peer-[&:not(:focus):invalid]:block': failedSubmit }"  >
            ...
            <div class="sm:col-span-3 mt-0">
              ...
              <label v-if="store.logInMethod !== 'form'" class="ml-2" id="checkBoxTos">
                <span>{{ $t('form.tos1Label') }}</span>
                <a :href="tosLink" target="_blank" >{{ $t('form.tos2Label') }}</a>
              </label>
            </div> 
            <div class="flex flex-col sm:col-span-full">
              <button type="submit" :disabled="!info.tos"  :class="{ 'cursor-not-allowed': !info.tos, 'bg-slate-300':!info.tos, 'hover:bg-indigo-500': info.tos }" 
              class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm  border-0 sm:border-2 border-black border-solid">
